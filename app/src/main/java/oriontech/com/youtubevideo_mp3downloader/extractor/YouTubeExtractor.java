...
public abstract class YouTubeExtractor extends AsyncTask<String, String, SparseArray<YoutubeFile>> {
                    ...
                    while ((line = reader.readLine()) != null) {
                        if(line.startsWith("https://") || line.startsWith("http://")){
                            ...
                            if(mat.find()){
                                ...
                                YoutubeFile newFile = new YoutubeFile(FORMAT_MAP.get(itag), line);
            ...
            if (signature == null) {
                ...
                for (int i = 0; i < encSignatures.size() && i < sigs.length; i++) {
                    ...
                    if (key == 0) {
                        ...
                        YoutubeFile newFile = new YoutubeFile(FORMAT_MAP.get(key), url);
    ...
    private void parseDashManifest(String dashMpdUrl, SparseArray<YoutubeFile> ytFiles) throws IOException {
        ...
        while (mat.find()) {
            ...
            YoutubeFile yf = new YoutubeFile(FORMAT_MAP.get(itag), url);
