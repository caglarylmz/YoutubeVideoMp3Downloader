package oriontech.com.youtubevideo_mp3downloader.activities;
...
import oriontech.com.youtubevideo_mp3downloader.R;
import oriontech.com.youtubevideo_mp3downloader.extractor.VideoMeta;
import oriontech.com.youtubevideo_mp3downloader.extractor.YouTubeExtractor;
import oriontech.com.youtubevideo_mp3downloader.extractor.YoutubeFile;
...
public class DownloadActivity extends AppCompatActivity {
    ...
    private LinearLayout fileTypesLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fileTypesLayout = findViewById(R.id.layout_file_types);
        ...
        if (savedInstanceState == null && Intent.ACTION_SEND.equals(getIntent().getAction())
            ...
            String ytLink = getIntent().getStringExtra("link");
    ...
    private void addFormatToList(YoutubeFile ytFile, SparseArray<YoutubeFile> ytFiles) {
    ...
    private class YtFragmentedVideo {
        int height;
        YoutubeFile audioFile;
        YoutubeFile videoFile;
    }
}